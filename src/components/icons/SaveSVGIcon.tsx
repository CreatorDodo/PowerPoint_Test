interface SaveSVGIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
}
const SaveSVGIcon: React.FC<SaveSVGIconProps> = ({ size = 24, className, ...props }) => (
  <svg
  ...
  >
    ...
    />
    <g strokeWidth="38.0086" stroke="currentColor">
